...
//
// RankDisplay is the rank exactly as shown by the source ("3" for KKIK, "B" for
// a letter-ranked source) and is what lands in the your_rank column.
// RankOrder is the same rank projected onto a sortable scale where lower is
// better; sorting and diffing run on it so both numeric and letter ranks work.
